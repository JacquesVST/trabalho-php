...
$funcionario = $funcionarioController->listarPorID($_GET['id']);
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <br>
            <h4 class="text-left">Editar <?= $funcionario->getNome() ?></h4>
            <form action="../api/funcionario.php?motivo=editar&id=<?= $funcionario->getId() ?>" method="post">
                <div class="form-group">
                    nome
                    <input type="text" name="nome" value="<?= $funcionario->getNome() ?>" class="form-control" required>
                </div>
